        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="?page=produits&sub_page=list_product" class="<?php echo $sub_page == 'list_product' ? 'active' : '' ?>">Liste de produits</a>
                        </li>
                        <li><a href="?page=produits&sub_page=add_product" class="<?php echo $sub_page == 'add_product' ? 'active' : '' ?>">Ajouter un produit</a>
                        </li>
                        <li><a href="?page=produits&sub_page=list_categories" class="<?php echo $sub_page == 'list_categories' ? 'active' : '' ?>">Liste des
                                catégories</a></li>
                        <li><a href="?page=produits&sub_page=add_category" class="<?php echo $sub_page == 'add_category' ? 'active' : '' ?>">ajouter une
                                catégorie</a></li>
                        ...
                        <li><a href="?page=produits&sub_page=list_marques" class="<?php echo $sub_page == 'list_marques' ? 'active' : '' ?>">Liste des marques</a>
                        </li>
                        <li><a href="?page=produits&sub_page=add_marques" class="<?php echo $sub_page == 'add_marques' ? 'active' : '' ?>">Ajouter une marque</a>
                        </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="?page=ventes&sub_page=list_sales" class="<?php echo $sub_page == 'list_sales' ? 'active' : '' ?>">Liste des ventes</a>
                        </li>
                        <li><a href="?page=ventes&sub_page=add_sales" class="<?php echo $sub_page == 'add_sales' ? 'active' : '' ?>">POS</a></li>
                        <li><a href="?page=ventes&sub_page=add_sales" class="<?php echo $sub_page == 'invoice_list' ? 'active' : '' ?>">Nouvelles ventes</a>
                        </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="?page=achats&sub_page=list_achats" class="<?php echo $sub_page == 'list_achats' ? 'active' : '' ?>">Purchase List</a></li>
                        <li><a href="?page=achats&sub_page=add_achats" class="<?php echo $sub_page == 'add_achats' ? 'active' : '' ?>">Ajouter un achat</a>
                        </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="?page=clients&sub_page=list_clients" class="<?php echo $sub_page == 'list_clients' ? 'active' : '' ?>">Liste de clients</a>
                        </li>
                        <li><a href="?page=clients&sub_page=add_clients" class="<?php echo $sub_page == 'add_clients' ? 'active' : '' ?>">Ajouter un client </a>
                        </li>

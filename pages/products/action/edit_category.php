...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $is_logged) {
    ...
    switch ($imgUploaded ?? 0) {
        ...
        case 3:
            ...
            break;
        default:
            $result = editRow('categories', $data, $id);
            if ($result) {
            ...
            <form method="post" class="row" enctype="multipart/form-data" >
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea name="category_description" class="form-control"><?php echo $category_description ?></textarea>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                            ...
                            <li class="ps-0">
                                <div class="productviews">
                                    <div class="productviewsimg">
                                        <img src="<?php echo $category_upload_dir . $category_img ?>" alt="img">
                                    </div>
